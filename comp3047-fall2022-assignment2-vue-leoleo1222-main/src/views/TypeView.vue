        ...
        <div class="col" v-for="item in inventory" :key="item._id">
          <div class="card" style="height:200px;">
            ...
            <router-link :to="'/' + $route.params.type + '/detail/' + item._id">
              <img :src="item.image" class="card-img-top" alt="..." style="height:100px;" />
            </router-link>
            <div class="card-body">
...
export default {
  ...
  setup() {
    ...
    const fetchPage = async function (page) {
      ...
      var response = await fetch("/api/inventory?perPage=" + perPage.value + "&page=" + page + "&category=" + route.params.type);
    ...
    watch(() => route.params.type, () => fetchPage(currentPage.value));
